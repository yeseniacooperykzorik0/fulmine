...
func runOnLoad() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_runOnLoad_61f9`,
		Function: `function __templ_runOnLoad_61f9(){updateFiatValues()
	//
	...
	if (settings.Unit !== "sat") toggleUnit()
		...
		Call:       templ.SafeScript(`__templ_runOnLoad_61f9`),
		CallInline: templ.SafeScriptInline(`__templ_runOnLoad_61f9`),
	}
}
