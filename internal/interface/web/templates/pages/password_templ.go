...
func SetPasswordContent() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<p class=\"mb-10\">Create a password that will be used to unlock your wallet.</p><p class=\"mb-2\">Password</p><div class=\"flex justify-between items-center gap-4 bg-graybg border-1 border-white/10 p-2 rounded w-full\"><input autocomplete=\"new-password\" class=\"bg-graybg border-0 w-full\" name=\"password\" oninput=\"checkPass()\" type=\"password\"><p class=\"eyes\" onclick=\"toggleVisibility()\"><span>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</span></p></div><p class=\"mt-4 mb-2\">Repeat password</p><div class=\"flex justify-between items-center gap-4 bg-graybg border-1 border-white/10 p-2 rounded w-full\"><input autocomplete=\"new-password\" class=\"bg-graybg border-0 w-full\" name=\"pconfirm\" oninput=\"checkPass()\" type=\"password\"><p class=\"eyes\" onclick=\"toggleVisibility()\"><span>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = components.EyeOpenIcon().Render(ctx, templ_7745c5c3_Buffer)
